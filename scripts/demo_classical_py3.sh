...
# Demo script showing classical load balancer + traffic generator integration using python 3
...
if ! which python3 &> /dev/null; then
    echo "Error: Python 3 is required but not installed if you use pytho run demo_classical_py.sh"
    exit 1
fi
